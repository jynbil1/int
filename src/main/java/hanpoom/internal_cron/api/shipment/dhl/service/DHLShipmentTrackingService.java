...
import hanpoom.internal_cron.api.shipment.dhl.config.MyDHLClient;
import hanpoom.internal_cron.api.shipment.dhl.field.DHLAPIType;
import hanpoom.internal_cron.api.shipment.dhl.vo.request.DHLTrackingRequest;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.DHLTrackingResponse;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.DHLTrackingResponseStorage;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.Consignee;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.PieceDetail;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.ServiceArea;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.ShipmentDetail;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.ShipmentEvent;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.Shipper;
import hanpoom.internal_cron.api.shipment.dhl.vo.response.element.Status;
