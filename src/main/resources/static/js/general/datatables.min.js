 ...
 *   https://datatables.net/download/#bs-3.3.6/jqc-1.12.0/dt-1.10.11
 *
 * Included libraries:
 *  jQuery 1.12.0, Bootstrap 3.3.6, DataTables 1.10.11
 */
...
(function(h) {
    ...
    m.ext = v = {
        buttons: {},
        classes: {},
        builder: "bs-3.3.6/jqc-1.12.0/dt-1.10.11",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
